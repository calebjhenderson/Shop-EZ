...
const addOrderToUser = async (userId, orderId) => {
    try {
        ...
        console.error(
            `There's been an error adding an order to a user @ addOrderToUser(productId, orderId) in ./db/user_orders.js. ${error}`
        );
        throw error;
    }
};
...
const deleteOrderFromUser = async (userOrderId) => {
    try {
        ...
        console.error(
            `There's been an error deleting an order from a user @ deleteOrderFromUser(userOrderId) in ./db/user_orders.js. ${error}`
        );
        throw error;
    }
};
...
const getUserOrderById = async (userOrderId) => {
    try {
        ...
        console.error(
            `There's been an error getting a user order by id @ getUserOrderById(userProductId) in ./db/user_orders.js. ${error}`
        );
        throw error;
    }
};
...
const getUserOrdersByUserId = async (userId) => {
    try {
        ...
        console.error(
            `There's been an error getting user orders by user id @ getUserOrdersByUserId(userId) in ./db/user_products.js. ${error}`
        );
        throw error;
    }
};
...
const getUserOrdersByOrderId = async (orderId) => {
    try {
        ...
        console.error(
            `There's been an error getting user orders by order id @ getUserOrdersByOrderId(orderId) in ./db/user_products.js. ${error}`
        );
        throw error;
    }
};
